        ...
        <div className="max-w-[1600px] mx-auto">
          ...
          <div className="text-center max-w-6xl mx-auto mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#f3ede1] border border-[#ded4c3] text-[11px] md:text-xs tracking-[0.22em] uppercase text-[#7d561d] mb-8 font-semibold shadow-sm">
              Marroquinaria Inteligente D2C • Peça Fundadora Edição 001
            </div>
            
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif tracking-tight leading-[1.14] text-[#141210] mb-8 max-w-5xl mx-auto">
              Sua autoridade merece mais do que um publi passageiro: <span className="italic text-[#8c5e23] block md:inline">co-crie e assine sua própria bolsa de luxo.</span>
            </h1>
            
            <div className="space-y-4 text-base md:text-xl text-[#332e29] font-normal leading-relaxed mb-12 max-w-4xl mx-auto">
              <p className="leading-relaxed">
                A maioria das bolsas premium foi desenhada apenas para ser bonita. A <strong className="text-[#141210] font-semibold">Barbara Brown Tech Tote</strong> foi desenhada para fazer mais: unir couro nobre e a estética do <em>Quiet Luxury</em> a uma engenharia oculta que resolve a rotina real da mulher contemporânea.
              </p>
              <p className="text-sm md:text-lg text-[#47413a] leading-relaxed">
                Convidamos um grupo limitado de criadoras e mulheres de negócios para participar da criação de um modelo assinado com a nossa marroquinaria inteligente — sem necessidade de fábrica, estoque ou operação própria.
              </p>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div id="diferenciais" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <div className="p-6 rounded-2xl bg-white border border-[#e5ded0] shadow-sm hover:shadow-md hover:border-[#a87a38]/60 transition-all">
              ...
              <h4 className="text-base font-serif text-[#141210] mb-2 font-bold">EASY-ACCESS PHONE POCKET</h4>
              <p className="text-xs text-[#57514a] leading-relaxed">
                Um bolso de acesso rápido para celular com fechamento magnético seguro, para você nunca mais perder ligações procurando o telefone no fundo da bolsa.
              </p>
            </div>

            <div className="p-6 rounded-2xl bg-white border border-[#e5ded0] shadow-sm hover:shadow-md hover:border-[#a87a38]/60 transition-all">
              <span className="text-xs font-mono text-[#8c5e23] font-bold tracking-widest block mb-1">06</span>
              <h4 className="text-base font-serif text-[#141210] mb-2 font-bold">FORRO CLARO EM CHAMPAGNE</h4>
              <p className="text-xs text-[#57514a] leading-relaxed">
                O forro acetinado claro resolve o problema do "buraco negro": você encontra chaves, batons e pequenos objetos imediatamente, sem esforço.
              </p>
            </div>

            <div className="p-6 rounded-2xl bg-white border border-[#e5ded0] shadow-sm hover:shadow-md hover:border-[#a87a38]/60 transition-all">
              <span className="text-xs font-mono text-[#8c5e23] font-bold tracking-widest block mb-1">07</span>
              <h4 className="text-base font-serif text-[#141210] mb-2 font-bold">RFID SAFE POCKET</h4>
              <p className="text-xs text-[#57514a] leading-relaxed">
                Compartimento interno com proteção eletromagnética para cartões e documentos que utilizam tecnologia RFID, adicionando uma camada de proteção contra leituras por aproximação.
              </p>
            </div>

            <div className="p-6 rounded-2xl bg-white border border-[#e5ded0] shadow-sm hover:shadow-md hover:border-[#a87a38]/60 transition-all">
              <span className="text-xs font-mono text-[#8c5e23] font-bold tracking-widest block mb-1">08</span>
              <h4 className="text-base font-serif text-[#141210] mb-2 font-bold">LEVEZA ESTRUTURADA</h4>
              <p className="text-xs text-[#57514a] leading-relaxed">
                Ninguém deveria carregar peso morto antes mesmo de colocar seu equipamento de trabalho. A construção busca equilibrar estrutura, capacidade e leveza para acompanhar jornadas longas com mais conforto.
              </p>
            </div>
